...
class EditarVacunacion : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val sintoma = resources.getStringArray(R.array.Sintomas)
        val adapterSintoma = ArrayAdapter(
            this,
            R.layout.lista_sintomas,
            sintoma
        )
        with(binding.etEditSintomas){
            setAdapter(adapterSintoma)
        }
